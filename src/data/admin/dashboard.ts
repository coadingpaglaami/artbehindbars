...
export const categoryData: CategoryData[] = [
  { name: "Religious", value: 65, count: 65 },
  { name: "Non-Religious", value: 35, count: 35 },
];
...
export const activityData: ActivityData[] = [
  {
    type: "upload",
    title: 'Alice had uploaded art "Dream Solitude"',
    time: "6 minutes ago",
  },
  {
    type: "member",
    title: "New artwork uploaded by John Doe",
    time: "15 minutes ago",
  },
  {
    type: "auction",
    title: "Pair just received bid for Sarah Jones",
    time: "1 hour ago",
  },
  {
    type: "registration",
